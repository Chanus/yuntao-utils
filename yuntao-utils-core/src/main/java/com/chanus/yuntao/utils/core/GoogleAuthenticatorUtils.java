...
public class GoogleAuthenticatorUtils {
    ...
    /**
     * 生成一个 Google 身份验证器，识别的字符串，只需要把该方法返回值生成二维码扫描就可以了
     *
     * @param user   账号
     * @param secret 密钥
     * @return
    ...
    /**
     * Check the code entered by the user to see if it is valid 验证 code 是否合法
     *
    ...
    private static long verify(byte[] key, long t) throws NoSuchAlgorithmException, InvalidKeyException {
